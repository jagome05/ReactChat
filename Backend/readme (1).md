...
- [ ] Toggle Auth components 
- [ ] Auth - Register new User
- [ ] Auth - Login existing User
- [ ] Auth - After Login or Register, update the token in local storage
- [ ] Rooms - View rooms
- [ ] Rooms - Create a room
- [ ] Messages - View messages in a room
- [ ] Messages - Create a message in a room
